    ...
    function scroll($container, direction) {
        ...
        $container.find('ul li').each(function (index, element) {
            ...
            if (i !== undefined) {
                ...
                if((1 - scales) * config.maxHeight / 2==0){
                    $(element).find('.btnClk').attr('tabindex','0').focus();
               
                    $(element).find('.orangeOpac').animate({
                        opacity:0
                    },config.animationTime);
                }else{
                    $(element).find('.btnClk').removeAttr('tabindex');
                    $(element).find('.orangeOpac').animate({
                        opacity:1
                    },config.animationTime);
                }
            ...
            if (typeof param === 'object' && param !== null) {
               ...
               //     return;
                ...
                $(document).keyup(function(e) {
                    ...
                    if ((e.keyCode ? e.keyCode : e.which) === 39) {
                            scroll($target, 'right');
                    }
